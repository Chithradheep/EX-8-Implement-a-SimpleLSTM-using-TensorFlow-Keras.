...
y = np.sin(2 * np.pi * freq * x) + (np.random.normal(scale=noise,
size=n_points) if noise > 0 else 0)
return y
...
by repeatedly appending predictions and using the last WINDOW_SIZE values as
input.
"""
seq = seed_sequence.copy().tolist()
preds = []
for _ in range(n_steps):
x_in = np.array(seq[-WINDOW_SIZE:])[np.newaxis, ..., np.newaxis] # shape
(1, WINDOW_SIZE, 1)
...
plt.plot(np.arange(WINDOW_SIZE, WINDOW_SIZE + len(future_preds)), future_preds,
...
# EPOCH:
<img width="1804" height="670" alt="image" src="https://github.com/user-attachments/assets/980ea8a9-2423-4283-a1b7-f51890fe5bef" />

# TEST LOSS(MSE):
<img width="1809" height="289" alt="image" src="https://github.com/user-attachments/assets/c6c3777b-35bc-4a42-86d1-5ec54019fdf7" />

# PLOT PREDICTIONS:
<img width="1398" height="577" alt="image" src="https://github.com/user-attachments/assets/218d30b1-53bb-4815-9268-2792571e9ca4" />

# ROLLING FORECAST:
<img width="1464" height="461" alt="image" src="https://github.com/user-attachments/assets/b51be4a9-4a43-4f06-861d-e77ac629e177" />
